...
;;
;; Run via: eldev eval -R --file .cli-audit/20260604-184038/audit.el
;; (Actually: load via -f loadable arg.)
;;
;; Reads:
;;   .cli-audit/20260604-184038/classes.json
;;   .cli-audit/20260604-184038/help/<path>.txt    (cached `bd P --help' output)
;;
;; Writes:
;;   .cli-audit/20260604-184038/flags.md  (per-class slot drift report)
;;   .cli-audit/20260604-184038/inheritance.md (global flags inheritance)
;;
...
(defconst audit-run-dir ".cli-audit/20260604-184038")
