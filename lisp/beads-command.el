...
Part of beads.el's supported, stable command-bridge extension
contract, together with `beads-command-execute-interactive' and
`beads-command-preview'.  Transient menus generated by
`beads-meta-define-transient' call this first and refuse to execute or
preview on a non-nil result.  See the manual node \"Extending
beads.el\".")
...
Part of beads.el's supported, stable command-bridge extension
contract, together with `beads-command-validate' and
`beads-command-preview'.  The \"Execute\" suffix of a generated
transient menu invokes this after validation succeeds.  See the manual
...
Part of beads.el's supported, stable command-bridge extension
contract, together with `beads-command-validate' and
`beads-command-execute-interactive'.  The \"Preview\" suffix of a
generated transient menu invokes this after validation succeeds.  See
