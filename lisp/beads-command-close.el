...
;; The autoload below is required for the transient menu generated by
;; beads-defcommand-with-transient.  The eval-and-compile wrapper is
;; no longer needed here — beads-defcommand handles it internally.
